...
public class DiscussionDiscussioN extends AbstractJavaSamplerClient {
	//拉取讨论组信息
...
//	    	int user =  Integer.valueOf(arg0.getParameter("user"));
	        ...
	        try {
	            ...
	            ByteBuffer bytebuffer = client.discussion(discussId);  
...
//	        params.addArgument("version",version);
	    	...
	    	DiscussionDiscussioN test = new DiscussionDiscussioN();
