...
public class DiscussionLastModiTime  extends AbstractJavaSamplerClient  {
...
//	    	int user =  Integer.valueOf(arg0.getParameter("user"));
	        ...
	        try {
	            ...
	            ByteBuffer bytebuffer = client.lastModiTime(userId);  
...
//	    	addMember(long groupId, long adminId, String memberList, String version)
	    	...
	    	String Port = "11500";
//	    	String discussId = "471981";
	    	String userId = "343773";		//群成员信息，member[]的json数据  [2158568,2148733,2148724]
...
//	        params.addArgument("version",version);
	    	...
	    	DiscussionLastModiTime test = new DiscussionLastModiTime();
