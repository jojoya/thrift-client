...
public class Discussion_C_DelUserWithGroupChange   extends AbstractJavaSamplerClient{
	 ...
	 */
	    ...
	    public SampleResult runTest(JavaSamplerContext arg0) {
	    	...
	    	int corpId =  Integer.valueOf(arg0.getParameter("corpId"));
	        ...
	        try {
	            ...
	            ByteBuffer bytebuffer = client.delUserWithGroupChange(userId,corpId,userName);
...
//        params.addArgument("userList",userList);	//群成员信息，member[]的json数据
        ...
        params.addArgument("userName",userName);
       // params.addArgument("userAdd",userAdd);	//0只有管理员，1任何成员
        
        JavaSamplerContext arg0 = new JavaSamplerContext(params);
        
        Discussion_C_DelUserWithGroupChange test = new Discussion_C_DelUserWithGroupChange();
