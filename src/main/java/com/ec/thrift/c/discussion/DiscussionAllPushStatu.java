...
public class DiscussionAllPushStatu extends AbstractJavaSamplerClient  {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            ByteBuffer bytebuffer = client.allPushStatu(discussId);  
...
//					        int dataBody3 = BufferTo.byteToInt(arrStr2)
					        sb.append(dataBody3+"," + arrStr2[0] +",");
					        System.out.println(dataBody3+"," + arrStr2[0] +",");

//					        userList.append(dataBody3+"," + arrStr2 +",");
...
//    	addMember(long groupId, long adminId, String memberList, String version)
    	...
    	String Port = "11500";
    	String discussId = 	 "111111";//471994
        ...
        DiscussionAllPushStatu test = new DiscussionAllPushStatu();
