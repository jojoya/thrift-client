...
public class Discussion_Web_DisMembers  extends AbstractJavaSamplerClient {
...
//	    	int user =  Integer.valueOf(arg0.getParameter("user"));
	        ...
	        sr.setSamplerData("discussId："+discussId); 
	        try {
	            sr.sampleStart();	// 开始统计响应时间标记
	            result  = client.disMembers_web(discussId);  
...
//	        params.addArgument("version",version);
	        ...
	        Discussion_Web_DisMembers test = new Discussion_Web_DisMembers();
