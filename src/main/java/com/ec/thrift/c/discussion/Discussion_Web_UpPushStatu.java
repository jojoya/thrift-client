...
public class Discussion_Web_UpPushStatu extends AbstractJavaSamplerClient {
	//拉取讨论组信息
	    ...
	    public SampleResult runTest(JavaSamplerContext arg0) {
	        ...
	        sr.setSamplerData("discussId："+discussId+"userId"+userId+"lspush"+lspush); 
	        try {
	            sr.sampleStart();	// 开始统计响应时间标记
	            result  = client.upPushStatu_web(userId,discussId,lspush);  
...
//	    	addMember(long groupId, long adminId, String memberList, String version)
	    	...
	    	String userId = "2148733";		//群成员信息，member[]的json数据  [2158568,2148733,2148724]  2148088
	    	String lspush = "7";
...
//	        params.addArgument("version",version);
	        ...
	        Discussion_Web_UpPushStatu test = new Discussion_Web_UpPushStatu();
