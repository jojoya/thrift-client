...
public class Discussion_C_Update extends AbstractJavaSamplerClient {
...
//        String result = "";
        ...
        try {
            ...
            ByteBuffer bytebuffer = client.update(discussId, theme,adminId);  
...
//    	addMember(long groupId, long adminId, String memberList, String version)
    	...
    	String Port = "11500";
    	String discussId = "472201";
    	String timeStr = String.valueOf(System.currentTimeMillis());
    	String theme = "[:47)]n返回一块二进制的buff，包括三个字段code、msg、discussId、nums、theme，共326字节am111e"+timeStr;;		//群成员信息，member[]的json数据  [2158568,2148733,2148724]
    	String adminId = "343773"; //2148724
...
//        params.addArgument("version",version);
    	...
    	Discussion_C_Update test = new Discussion_C_Update();
