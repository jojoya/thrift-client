...
public class Discussion_C_DelMember extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            ByteBuffer bytebuffer = client.delMember(discussId, user);  
...
//    	addMember(long groupId, long adminId, String memberList, String version)
    	...
    	String Port = "11500";
    	String discussId = "472154";
    	String user = "2148088";		//群成员信息，member[]的json数据  [2158568,2148733,2148724]
...
//        params.addArgument("version",version);
    	...
    	Discussion_C_DelMember test = new Discussion_C_DelMember();
