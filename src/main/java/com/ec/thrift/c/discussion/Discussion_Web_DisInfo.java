...
public class Discussion_Web_DisInfo  extends AbstractJavaSamplerClient {
...
//	    	int user =  Integer.valueOf(arg0.getParameter("user"));
	        ...
	        try {
	            ...
	            result  = client.disInfo_web(discussId);  
...
//	        params.addArgument("version",version);
	        ...
	        Discussion_Web_DisInfo test = new Discussion_Web_DisInfo();
