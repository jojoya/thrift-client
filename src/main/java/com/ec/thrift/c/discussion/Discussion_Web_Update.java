...
public class Discussion_Web_Update extends AbstractJavaSamplerClient {
...
//	    	String version =  arg0.getParameter("version");
	        ...
	        sr.setSamplerData("discussId："+discussId+"theme"+name+"adminId"+adminId); 
	        try {
	            sr.sampleStart();	// 开始统计响应时间标记
	            
//	            int discussId, String name, int adminId
	            result  = client.update_web(discussId,name,adminId);  
...
//	    	addMember(long groupId, long adminId, String memberList, String version)
	    	...
	    	String name = "";		//群成员信息，member[]的json数据  [2158568,2148733,2148724]
	    	String adminId = "2148733";  // 2158568
...
//	        params.addArgument("version",version);
	        ...
	        Discussion_Web_Update test = new Discussion_Web_Update();
