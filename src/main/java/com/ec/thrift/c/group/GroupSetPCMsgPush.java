 ...
 */
public class GroupSetPCMsgPush extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            result = client.setPCMsgPush(groupId, adminId, isPush);
...
//    	(long groupId, long adminId, int memberAdd) 
    	...
    	GroupSetPCMsgPush test = new GroupSetPCMsgPush();
