 ...
 */
public class GroupSetMemberAdd extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
    	...
    	int memberAdd =  Integer.parseInt(arg0.getParameter("memberAdd"));
        ...
        try {
            ...
            result = client.setMemberAdd(groupId, adminId, memberAdd);
...
//    	(long groupId, long adminId, int memberAdd) 
        ...
        params.addArgument("memberAdd",String.valueOf(memberAdd));
        
        JavaSamplerContext arg0 = new JavaSamplerContext(params);
        
    	GroupSetMemberAdd test = new GroupSetMemberAdd();
