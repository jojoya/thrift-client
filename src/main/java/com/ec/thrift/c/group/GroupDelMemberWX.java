 ...
 */
public class GroupDelMemberWX extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            result = client.delMemberWX(groupId, adminId, memberList);
...
//             }
    ...
    public static void main(String [] args){
    	...
    	String Port = "11600";
    	String adminId = "2148724";
    	String groupId = "1015931";
...
//        memberListItem0.put("f_name", "接口员工4"); 
//        JSONObject memberListItem1 = new JSONObject();  
//        memberListItem1.put("f_id", new Integer(5024956));  
//        memberListItem1.put("f_name", "user2"); 
...
//        memberListArray.add(1, memberListItem1);  
    	...
    	GroupDelMemberWX test = new GroupDelMemberWX();
