 ...
 */
public class GroupSetPhoneMsgPush extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
    	...
    	int isPush =  Integer.parseInt(arg0.getParameter("isPush"));
        ...
        try {
            ...
            result = client.setPhoneMsgPush(groupId, adminId, isPush);
...
//    	(long groupId, long adminId, int memberAdd) 
        ...
        params.addArgument("isPush",String.valueOf(isPush));
        
        JavaSamplerContext arg0 = new JavaSamplerContext(params);
        
    	GroupSetPhoneMsgPush test = new GroupSetPhoneMsgPush();
