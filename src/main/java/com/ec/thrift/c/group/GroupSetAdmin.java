 ...
 */
public class GroupSetAdmin extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            result = client.setAdmin(groupId, adminId, memberList);
...
//        memberListArray.add(1, memberListItem1);  
    	...
    	GroupSetAdmin test = new GroupSetAdmin();
