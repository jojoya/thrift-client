 ...
 */
public class GroupModifyNotice extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            result = client.modifyNotice(groupId, adminId, notice);
...
//      modifyNotice(long groupId, long adminId, String notice)

    	String Host = "10.0.200.168";
    	String Port = "11600";
    	String adminId = "5024944";
    	String groupId = "1007721";
    	...
    	GroupModifyNotice test = new GroupModifyNotice();
