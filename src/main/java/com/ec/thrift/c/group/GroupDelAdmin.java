 ...
 */
public class GroupDelAdmin extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            result = client.delAdmin(groupId, adminId, memberList);
...
//             }
    ...
    public static void main(String [] args){
        ...
        memberListItem0.put("f_id", new Integer(5024952));  
        memberListItem0.put("f_name", "【开发库】user1"); 
    	...
    	GroupDelAdmin test = new GroupDelAdmin();
