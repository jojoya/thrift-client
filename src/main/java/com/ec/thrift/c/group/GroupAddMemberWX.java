 ...
 */
public class GroupAddMemberWX extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            result = client.addMemberWX(groupId, adminId, memberList);
...
//    	addMember(long groupId, long adminId, String memberList, String version)
    	...
    	GroupAddMemberWX test = new GroupAddMemberWX();
