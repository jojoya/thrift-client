 ...
 */
public class GroupDelMemberBat extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            result = client.delMemberBat(groupId, adminId, memberList);
...
//             }
    ...
    public static void main(String [] args){
    	...
    	String groupId = "1015833";
    	String memberList = "";		//成员信息，member[]的json数据
    	
       	//{"memberList": [{"f_id": 5024944,"f_name":"【开发库】代理商管理员"}]} 
        JSONObject memberListItem0 = new JSONObject();  
        memberListItem0.put("f_id", new Integer(2148088));  
        memberListItem0.put("f_name", "【测试】接口自动化"); 
        JSONObject memberListItem1 = new JSONObject();  
        memberListItem1.put("f_id", new Integer(2148724));  
        memberListItem1.put("f_name", "接口员工3"); 
        JSONObject memberListItem2 = new JSONObject();  
        memberListItem2.put("f_id", new Integer(2148733));  
        memberListItem2.put("f_name", "接口员工4"); 
        
        // 返回一个JSONArray对象  
        JSONArray memberListArray = new JSONArray();  
        memberListArray.add(0, memberListItem0);  
        memberListArray.add(1, memberListItem1);  
        memberListArray.add(2, memberListItem2);  
    	...
    	GroupDelMemberBat test = new GroupDelMemberBat();
