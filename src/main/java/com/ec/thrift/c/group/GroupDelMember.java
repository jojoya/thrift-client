 ...
 */
public class GroupDelMember extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        try {
            ...
            result = client.delMember(groupId, adminId, userId);
...
//    	(long groupId, long adminId, int memberAdd) 
    	...
    	GroupDelMember test = new GroupDelMember();
