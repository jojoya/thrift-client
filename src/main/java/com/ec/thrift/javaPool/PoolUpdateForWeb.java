 ...
 * @date 2017年1月12日 下午3:52:56
 */
public class PoolUpdateForWeb extends AbstractJavaSamplerClient {
...
//        sr.setSampleLabel("execute createForWeb method");
        ...
        try {
            ...
            result = client.updateForWeb(stringJson, table, version);
...
//            System.out.println(result);
    ...
    public Arguments getDefaultParameters() {
      ...
      public static void main(String[] args) { 
	      ...
	      PoolUpdateForWeb ht = new PoolUpdateForWeb(); 
	      ht.setupTest(arg0); 
	      ht.runTest(arg0); //
