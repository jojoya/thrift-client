 ...
 * @date 2017年1月12日 下午3:52:56
 */
public class PoolCreateForServer extends AbstractJavaSamplerClient {
...
//        sr.setSampleLabel("execute createForWeb method");
        ...
        try {
            ...
            result = client.createForServer(stringJson, table, version);
 ...
 */
	      ...
	      PoolCreateForServer ht = new PoolCreateForServer(); 
	      ht.setupTest(arg0); 
	      ht.runTest(arg0); //
