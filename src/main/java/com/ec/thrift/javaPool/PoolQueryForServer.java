 ...
 * @date 2017年1月12日 下午3:52:56
 */
public class PoolQueryForServer extends AbstractJavaSamplerClient {
...
//        sr.setSampleLabel("execute createForWeb method");
        ...
        try {
            ...
            result = byteBufferToString(client.queryForServer(stringJson, table, version));
...
//		System.out.println(info);
    ...
    public Arguments getDefaultParameters() {
      ...
      public static void main(String[] args) { 
	      ...
	      PoolQueryForServer ht = new PoolQueryForServer(); 
	      ht.setupTest(arg0); 
	      ht.runTest(arg0); //
