 ...
 * @date 2017年1月12日 下午3:52:56
 */
public class PoolDeleteForWeb extends AbstractJavaSamplerClient {
...
//        sr.setSampleLabel("execute createForWeb method");
        ...
        try {
            ...
            result = client.deleteForWeb(stringJson, table, version);
...
//            System.out.println(result);
    ...
    public Arguments getDefaultParameters() {
      ...
      public static void main(String[] args) { 
	      ...
	      PoolDeleteForWeb ht = new PoolDeleteForWeb(); 
	      ht.setupTest(arg0); 
	      ht.runTest(arg0); //
