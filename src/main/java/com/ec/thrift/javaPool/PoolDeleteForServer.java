 ...
 * @date 2017年1月12日 下午3:52:56
 */
public class PoolDeleteForServer extends AbstractJavaSamplerClient {
...
//        sr.setSampleLabel("execute createForWeb method");
        ...
        try {
            ...
            result = String.valueOf(client.deleteForServer(stringJson, table, version));
...
//            System.out.println(result);
    ...
    public Arguments getDefaultParameters() {
      ...
      public static void main(String[] args) { 
	      Arguments params = new Arguments();
	      params.addArgument("stringJson", "{\"f_user_id\":5023540}");// 设置参数，
	      ...
	      PoolDeleteForServer ht = new PoolDeleteForServer(); 
	      ht.setupTest(arg0); 
	      ht.runTest(arg0); //
