 ...
 * @date 2017年1月12日 下午3:52:56
 */
public class PoolCreateForWeb extends AbstractJavaSamplerClient {
...
//        sr.setSampleLabel("execute createForWeb method");
        ...
        try {
            ...
            result = client.createForWeb(stringJson, table, version);
    ...
    public Arguments getDefaultParameters() {
      ...
      public static void main(String[] args) { 
	      ...
	      item.put("f_send_flag", new Integer(1)); 
	      ...
	      PoolCreateForWeb ht = new PoolCreateForWeb(); 
	      ht.setupTest(arg0); 
	      ht.runTest(arg0); //
